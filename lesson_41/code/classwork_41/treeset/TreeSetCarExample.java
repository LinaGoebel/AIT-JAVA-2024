...
public class TreeSetCarExample {
  ...
  public static void main(String[] args) {
    ...
    Car[] cars = new Car[5];
    cars[0] = new Car("N1", "Model1", 5, 2.0, 15000);
    cars[1] = new Car("N4", "Model2", 3, 2.5, 25000);
    cars[2] = new Car("N3", "Model1", 2, 3.0, 50000);
    cars[3] = new Car("N5", "Model3", 7, 1.4, 10000);
    cars[4] = new Car("N2", "Model2", 3, 2.5, 25000);//duplikat
    for (Car car : cars) {
      carTreeSet.add(car);
    }
